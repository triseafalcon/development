...
if ( !function_exists( 'seafood_company_template_team_3_theme_setup' ) ) {
	add_action( 'seafood_company_action_before_init_theme', 'seafood_company_template_team_3_theme_setup', 1 );
	function seafood_company_template_team_3_theme_setup() {
		seafood_company_add_template(array(
			'layout' => 'team-3',
			'template' => 'team-3',
			'mode'   => 'team',
			'title'  => esc_html__('Team /Style 3/', 'seafood-company'),
...
// Template output
if ( !function_exists( 'seafood_company_template_team_3_output' ) ) {
	function seafood_company_template_team_3_output($post_options, $post_data) {
		$show_title = true;
		...
		?>
			<div<?php echo !empty($post_options['tag_id']) ? ' id="'.esc_attr($post_options['tag_id']).'"' : ''; ?>
				...
				<div class="sc_team_item_avatar"><?php seafood_company_show_layout($post_options['photo']); ?>
					<div class="sc_team_item_hover">
						<div class="sc_team_item_socials"><?php seafood_company_show_layout($post_options['socials']); ?></div>
					</div>
				</div>
