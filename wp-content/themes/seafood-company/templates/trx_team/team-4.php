...
if ( !function_exists( 'seafood_company_template_team_4_theme_setup' ) ) {
	add_action( 'seafood_company_action_before_init_theme', 'seafood_company_template_team_4_theme_setup', 1 );
	function seafood_company_template_team_4_theme_setup() {
		seafood_company_add_template(array(
			'layout' => 'team-4',
			'template' => 'team-4',
			'mode'   => 'team',
			'title'  => esc_html__('Team /Style 4/', 'seafood-company'),
...
// Template output
if ( !function_exists( 'seafood_company_template_team_4_output' ) ) {
	function seafood_company_template_team_4_output($post_options, $post_data) {
		$show_title = true;
