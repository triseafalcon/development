...
if ( !function_exists( 'seafood_company_template_testimonials_3_theme_setup' ) ) {
	add_action( 'seafood_company_action_before_init_theme', 'seafood_company_template_testimonials_3_theme_setup', 1 );
	function seafood_company_template_testimonials_3_theme_setup() {
		seafood_company_add_template(array(
			'layout' => 'testimonials-3',
			'template' => 'testimonials-3',
			'mode'   => 'testimonials',
			'title'  => esc_html__('Testimonials /Style 3/', 'seafood-company'),
...
// Template output
if ( !function_exists( 'seafood_company_template_testimonials_3_output' ) ) {
	function seafood_company_template_testimonials_3_output($post_options, $post_data) {
		$show_title = true;
