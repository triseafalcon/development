...
if ( !function_exists( 'seafood_company_template_single_standard_theme_setup' ) ) {
	add_action( 'seafood_company_action_before_init_theme', 'seafood_company_template_single_standard_theme_setup', 1 );
	function seafood_company_template_single_standard_theme_setup() {
		seafood_company_add_template(array(
			'layout' => 'single-standard',
			'mode'   => 'single',
			'need_content' => true,
			'need_terms' => true,
			'title'  => esc_html__('Single standard', 'seafood-company'),
...
// Template output
if ( !function_exists( 'seafood_company_template_single_standard_output' ) ) {
	function seafood_company_template_single_standard_output($post_options, $post_data) {
		...
		$title_tag = seafood_company_get_custom_option('show_page_title')=='yes' ? 'h3' : 'h3';
